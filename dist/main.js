...
eval("//import fetch from 'node-fetch';\r\n\r\n async function postgame(game) {\r\nawait  fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/',{\r\n    method: 'POST',\r\n    headers: {      'Content-Type': 'application/json'\r\n    },\r\n    body: JSON.stringify({\"name\": game})\r\n   })\r\n}\r\n\r\nasync function postscores(name,score) {\r\n    await  fetch(\"https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/100/scores/\",{\r\n        method: 'POST',\r\n        headers: {'Content-Type': 'application/json'\r\n        },\r\n        body: JSON.stringify({\"user\": name, \"score\": score})\r\n       })\r\n       .then((response) => response.json())\r\n       .then((json) => console.log(json));\r\n    }\r\n  \r\n//postscores(\"carlos\",100)  \r\n\r\n\r\nasync function getscores() {\r\n  const response = await  fetch(\"https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/100/scores/\")\r\nlet data = await response.json()\r\n\r\nconsole.log(data)\r\n}\r\ngetscores()\r\n\r\n\r\n\r\nasync function deletepost() {\r\nconst value = await  fetch(\"https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/100/scores/\",{\r\n    method: 'DELETE'\r\n  })\r\n  let data = await value.json()\r\n\r\n  console.log(data)\r\n}\r\ndocument.getElementById('submit').addEventListener('submit',()=>{\r\nalert(\"asdasdasd\")\r\n})\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://leader-board/./src/modules/request.js?");
